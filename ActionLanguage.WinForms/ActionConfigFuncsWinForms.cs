...
namespace ActionLanguage
{
    public class ActionConfigFuncsWinForms : ActionConfigFuncs
    {
        ...
        {
            return ExtendedControls.PromptSingleLine.ShowDialog(ParentForm, lab1, defaultValue1, caption, ic, multiline, tooltip, cursoratend, width, vspacing);
        }
        ...
        {
            return ExtendedControls.PromptMultiLine.ShowDialog(ParentForm, caption, ic, lab, def, multiline, tooltips, cursoratend, width, vspacing);
        }
